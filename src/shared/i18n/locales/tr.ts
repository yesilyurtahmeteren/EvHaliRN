...
const tr = {
  ...
  list: {
    addItemHint: 'Ne eksik?',
    addItem: 'Ekle',
    addItemDetail: 'Detaylı ekle',
    emptyListMessage: 'Evde eksik bir şey yok',
    boughtSectionTitle: 'Alınanlar ({{count}})',
    categoryFilterAll: 'Tümü ({{count}})',
    itemBoughtMessage: '{{name}} alındı',
    undo: 'Geri al',
    offlineBanner: 'Çevrimdışısın, değişiklikler bağlanınca gönderilecek.',
    addedByLabel: 'Ekleyen: {{name}}',
    boughtByLabel: 'Alan: {{name}}',
    urgentBadge: 'Acil',
    quantityBadge: '{{quantity}} {{unit}}',
    checkItemLabel: '{{name}} alındı olarak işaretle',
    openDetailHint: 'Ürünü düzenlemek için dokun',
  },
  // Sabit liste: firestore.rules ile aynı anahtarlar (lib: shared/schemas/enums).
  categories: {
    fruit_vegetable: 'Meyve & Sebze',
    dairy_breakfast: 'Süt & Kahvaltı',
    meat_deli: 'Et & Şarküteri',
    bakery: 'Fırın',
    staple: 'Temel Gıda',
    beverage: 'İçecek',
    snack: 'Atıştırmalık',
  ...
  itemForm: {
    ...
    addSubtitle: '{{home}} ortak sepetine eklenecek',
    editSubtitle: 'Değişiklikler anında senkronize olur',
    nameLabel: 'Ürün adı',
    nameHint: 'Ne lazım? (örn. Süt, Ekmek)...',
    voiceInput: 'Sesle ekle',
    voiceInputComingSoon: 'Sesli giriş henüz eklenmedi.',
    quantityUnitLabel: 'Miktar & Birim',
    quantityLabel: 'Miktar',
    increase: 'Artır',
    decrease: 'Azalt',
    quickSuggestionsTitle: 'Sık Alınanlar',
    categorySectionTitle: 'Kategori',
    categoryNone: 'Kategori yok',
    noteLabel: 'Marka / not (isteğe bağlı)',
    urgentLabel: 'Acil İhtiyaç',
    urgentSubtitle: 'Markete giden ilk kişi hemen görsün',
    addButton: 'Listeye Ekle',
    saveButton: 'Kaydet',
    syncCaption: '{{names}} ile anında senkronize olur.',
